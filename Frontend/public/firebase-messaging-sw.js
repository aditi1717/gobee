...
const firebaseConfig = {
  ...
  authDomain: 'gobee-notifications.firebaseapp.com',
  projectId: 'gobee-notifications',
  storageBucket: 'gobee-notifications.firebasestorage.app',
...
messaging.onBackgroundMessage((payload) => {
  ...
  let icon = data.icon || notification.icon || '/logo.jpeg';
  let badge = '/logo.jpeg';

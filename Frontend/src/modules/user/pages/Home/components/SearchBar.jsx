...
const SearchBar = ({ onInputClick }) => {
  ...
  return (
    <div className="w-full relative cursor-pointer" onClick={onInputClick}>
      <div className="relative w-full group">
        ...
        <svg width="0" height="0" className="absolute">
          <linearGradient id="gobee-search-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
          <FiSearch
            ...
            style={{ stroke: 'url(#gobee-search-gradient)' }}
          />
        </div>

        {/* Simulated Input */}
        <div
          className="w-full pl-12 pr-4 py-3 rounded-2xl text-[15px] bg-white border border-gray-200 transition-all duration-300 text-gray-800 flex items-center h-[46px]"
          style={{

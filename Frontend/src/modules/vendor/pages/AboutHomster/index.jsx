    ...
    >
      ...
      <header className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-30 border-b border-gray-100">
        <div className="px-4 py-4 flex items-center gap-3">
          ...
          <span className="text-xl font-bold" style={homestrTextGradient}>About Go Bee</span>
        </div>
      </header>
      ...
      <main className="px-5 py-6 space-y-8">
        ...
        <motion.div variants={itemVariants} className="text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 mb-2">
            Welcome to <span style={homestrTextGradient}>Go Bee</span>
          </h1>
        ...
        <motion.div variants={itemVariants} className="text-center pt-4 border-t border-gray-200">
          ...
          <span className="text-sm font-bold tracking-wide" style={homestrTextGradient}>Go Bee Team</span>
